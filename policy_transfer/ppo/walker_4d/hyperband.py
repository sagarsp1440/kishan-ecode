...
class Hyperband:
    ...
    def __init__(self, get_params_function, train_params_function, xml_path, data_folder_path, seed, val1, val2, val3, val4):
        ...
        for s in range(self.s_max + 1):
            ...
            for i in range((s + 2) - int(skip_last)):  # changed from s + 1    #changed s+1 to s+2 - Kishan
                ...
                for t in T:
                    ...
                    result = self.train_params(n_iterations, t, self.xml_path, self.data_folder_path, self.val1, self.val2, self.val3, self.val4)
