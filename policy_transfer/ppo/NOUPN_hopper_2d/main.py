...
def train_params(args):
    def _train_params(n_iterations, params, xml_path, folder_path):
        ...
        args2 = ["python", "policy_transfer/ppo/NOUPN_hopper_2d/run_ppo.py", "--l_b4", l_b4, "--l_b3", l_b3, "--t3", t3, "--t4", t4,  "--n_iter", n_iterations, "--warmstart", "", "--env", args.env, "--seed", args.seed, "--name", args.name, "--min_timesteps", args.min_timesteps]
