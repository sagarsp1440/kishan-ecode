...
class Hyperband:
    ...
    def __init__(self, get_params_function, train_params_function, xml_path, data_folder_path, seed):
        ...
        self.max_episodes = 27  # maximum episodes per configuration/no. of configurations 
