...
class Hyperband:
    ...
    def __init__(self, get_params_function, train_params_function, xml_path, data_folder_path, seed, config_count, eta_val):
        ...
        self.eta = eta_val  # defines configuration down sampling rate (default = 3)
