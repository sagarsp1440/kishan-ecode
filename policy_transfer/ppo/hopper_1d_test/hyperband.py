...
class Hyperband:
    ...
    def __init__(self, get_params_function, train_params_function, xml_path, data_folder_path, seed, config_name):
        ...
        self.max_episodes = 9  # maximum episodes per configuration/no. of configurations 
    ...
    def run(self, skip_last=0, dry_run=False):
        ...
        for s in reversed(range(self.s_max + 1)):
            ...
            for i in range((s + 1) - int(skip_last)):                           # changed from s + 1    #changed s+1 to s+2 - Kishan  #revison: changed back to s+1 temperorily
                ...
                for t in T:
                    ...
                    result = self.train_params(n_iterations, t, self.xml_path, self.data_folder_path, self.config_name)
